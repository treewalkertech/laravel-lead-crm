...
return [
    'acl' => [
        ...
        'inventory' => 'المخزون',
        'prospects' => 'Prospects',
        'prospects_convert' => 'Convert to Lead',
    ],
    'users' => [
    ...
    'prospects' => [
        'index' => [
            'title' => 'Prospects',
            'create-btn' => 'Create Prospect',
            'create-success' => 'Prospect created successfully.',
            'update-success' => 'Prospect updated successfully.',
            'delete-success' => 'Prospect deleted successfully.',
            'delete-failed' => 'Prospect can not be deleted.',
            'datagrid' => [
                'id' => 'ID',
                'name' => 'Name',
                'industry' => 'Industry',
        ...
        'status' => [
            ...
            'contacted' => 'Contacted',
            'wrong-number-email' => 'Wrong Number/Email',
        ],
        'contacts' => [
            'convert-success' => 'Contact converted to a lead successfully.',
            'already-converted' => 'This contact has already been converted to a lead.',
            'converted-lead-title' => ':contact - :organization',
        ],
    ],
    'products' => [
        'index' => [
                ...
                'persons' => [
                    ...
                    'validation' => [
                        'errors' => [
                            ...
                            'invalid-date' => 'التاريخ: \'%s\' ليس تاريخًا صالحًا.',
                        ],
                    ],
                ],
                'products' => [
